...
export const ATTRIBUTION_REVISION = 3; // 3: judged on recorded edit paths (repo or not), renamed checkouts resolve via their project; 2: worktree-aware repo identity + per-file commit matching; missing revision is legacy
