...
make verify          # node verify.mjs opencode_time_full.html (headless Chromium, 52 checks)
...
make smoke           # one write through a fresh `opencode2 run` in /tmp; proves the plugin loads and records
```
